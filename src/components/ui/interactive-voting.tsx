    ...
    <section id="vote" className="relative min-h-screen w-full overflow-hidden flex flex-col pt-20">
      ...
      <AnimatePresence mode="wait">
        {!activeCategoryId ? (
          ...
          >
            {/* Gallery Header */}
            <div className="mx-auto max-w-7xl px-6 pt-20 mb-20 text-center">
              <motion.div 
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                className="font-signature text-6xl text-gold mb-6"
              >
                Le Grand Salon
              </motion.div>
              <h2 className="font-serif text-4xl md:text-6xl text-ivory tracking-[0.2em] uppercase font-light">
                Les Œuvres de l&apos;Excellence
              </h2>
              <div className="mt-10 flex items-center justify-center gap-6">
                <div className="h-[0.5px] w-24 bg-gold/40" />
                <span className="text-[11px] font-bold uppercase tracking-[0.6em] text-gold/80 italic">
            ...
            <div className="flex-1 flex items-center overflow-x-auto no-scrollbar snap-x snap-mandatory px-12 md:px-[15vw] pb-48">
                ...
                {categories.map((category, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex-none w-[320px] md:w-[450px] snap-center cursor-pointer group"
                    >
                      ...
                      <div className="parisian-frame group-hover:shadow-[0_60px_100px_-20px_rgba(0,0,0,1),0_0_30px_rgba(212,175,55,0.15)] transition-all duration-1000">
                        <div className="parisian-frame-inner">
                          <article className="relative h-[600px] bg-[#050505] flex flex-col items-center justify-center p-14 text-center">
                            {/* Texture background */}
                            ...
                            <div className="relative z-10">
                              <span className="font-serif text-9xl text-gold/[0.05] block mb-10 italic group-hover:text-gold/[0.1] transition-colors duration-1000">
                                {category.index}
                              </span>
                              <h3 className="font-serif text-5xl text-ivory/90 mb-8 leading-[1.1] tracking-tight group-hover:text-gold transition-colors duration-700">
                                {category.name}
                              </h3>
          ...
          >
            ...
            <div className="mx-auto max-w-7xl w-full px-6 pt-10 mb-12">
              <button
                onClick={() => setActiveCategoryId(null)}
                className="flex items-center gap-4 text-gold/40 hover:text-gold transition-all mb-12 group"
              >
                <ChevronLeft size={24} className="group-hover:-translate-x-3 transition-transform" />
                <span className="text-[11px] font-bold uppercase tracking-[0.6em] italic">Quitter le Salon</span>
              </button>

              <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 border-b border-ivory/5 pb-16">
                <div>
                  <motion.div 
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="font-signature text-5xl text-gold mb-4"
                  >
                    {activeCategory?.subtitle}
                  </motion.div>
                  <h2 className="font-serif text-5xl md:text-8xl text-ivory tracking-widest uppercase font-light">
                    {activeCategory?.name}
                  </h2>
                </div>
            ...
            <div 
              ref={scrollRef}
              className="flex-1 flex items-center overflow-x-auto snap-x snap-mandatory no-scrollbar px-[calc(50vw-min(650px,45vw))] pb-56"
            >
              <div className="flex gap-32">
                {activeCategory?.nominees.map((nominee, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex-none w-[380px] md:w-[550px] snap-center"
                    >
                      ...
                      <div className="parisian-frame-haussmann group hover:shadow-[0_80px_120px_-30px_rgba(0,0,0,1)] transition-all duration-1000">
                        <div className="parisian-frame-inner">
                          <article className="relative h-[750px] bg-[#080808] flex flex-col group overflow-hidden">
                            ...
                            <div className="relative h-[65%] w-full bg-[#111] overflow-hidden">
                              ...
                              <div className="absolute bottom-0 w-full p-12 bg-gradient-to-t from-black via-black/60 to-transparent">
                                <motion.h3 
                                  className="font-serif text-5xl text-ivory tracking-wide mb-4"
                                >
                                  {nominee.name}
                                </motion.h3>
                                <p className="text-[11px] text-gold/70 uppercase tracking-[0.5em] italic font-light">
                                  {nominee.description}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex-1 p-12 flex flex-col justify-center items-center bg-[#050505] relative">
                              {/* Museum Brass Plate Effect */}
                              <div className="absolute -top-6 left-1/2 -translate-x-1/2 px-8 py-3 bg-[#c5a059] text-black shadow-lg">
                              ...
                              <div className="mt-8 w-full">
                                <button
                                  className={`w-full py-7 text-[11px] font-bold uppercase tracking-[0.5em] transition-all relative overflow-hidden group/btn ${
                                    alreadyVoted 
                ...
                <div className="flex-none w-[25vw]" />
              </div>
            </div>

            {/* Scroll Indicator */}
            <div className="fixed bottom-32 left-0 w-full flex justify-center pointer-events-none z-20">
               <motion.div 
                animate={{ opacity: [0.3, 0.6, 0.3], y: [0, 5, 0] }}
                transition={{ duration: 4, repeat: Infinity }}
                className="text-ivory/40 text-[10px] uppercase tracking-[1em] flex flex-col items-center gap-6"
               >
